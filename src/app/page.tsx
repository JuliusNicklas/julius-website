...
export default function Home() {
  return (
      <main className="relative min-h-screen text-foreground">
        ...
        <div className="relative z-10 py-24 px-10 gap-8 flex flex-col items-center max-w-5xl mx-auto bg-background/70 backdrop-blur-sm">
          <h1>Julius' supersexy website</h1>
          <div className="py-4 flex flex-col items-center">
            <Image src={dragon_gif} alt="Dancing Dragon" width={400} height={400} loading="eager"/>
          ...
          <div className="border-t-2 py-8 gap-4 w-full flex flex-col items-center font-bold">
            <a href="https://github.com/JuliusNicklas">GitHub</a>
            <a href="https://www.linkedin.com/in/julius-gustafsson-bivrén">Linkedin</a>
          </div>
        </div>
